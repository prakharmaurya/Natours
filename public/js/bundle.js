...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiMDAwZXhjZWwiLCJhIjoiY2s4aW56OWM4MDM1YTNrcnc3eDZiYngzMyJ9.CdQ6duS7dAsrUzU6oVuHnw';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bound to include the current map
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1/api/v1/users/updatemypassword' : 'http://127.0.0.1/api/v1/users/updateme';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_KlLSAl09QPD1hUxhXrWr0Wbp00mfy8JvSl');
